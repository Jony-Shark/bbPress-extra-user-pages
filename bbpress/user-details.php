...
<div id="bbp-single-user-details">
    ...
    <div id="bbp-user-navigation">
        <ul>
            <li class="<?php if (bbp_is_single_user_profile() ) { echo 'current'; } ?>">
            ...
            <li class="<?php if (bbp_is_single_user_topics() ) { echo 'current'; } ?>">
            ...
            <li class="<?php if (bbp_is_single_user_replies() ) { echo 'current'; } ?>">
            ...
            <?php if (bbp_is_engagements_active() ) : ?>
                <li class="<?php if (bbp_is_single_user_engagements() ) { echo 'current'; } ?>">
            ...
            <?php if (bbp_is_favorites_active() ) : ?>
                <li class="<?php if (bbp_is_favorites() ) { echo 'current'; } ?>">
            ...
            <?php if (bbp_is_user_home() || current_user_can('edit_user', bbp_get_displayed_user_id()) ) : ?>
                ...
                <?php if (bbp_is_subscriptions_active() ) : ?>
                    <li class="<?php if (bbp_is_subscriptions() ) { echo 'current'; } ?>">
                ...
                <li class="<?php if (bbp_is_single_user_edit() ) { echo 'current'; } ?>">
                ...
                <?php do_action('beup_extra_user_page_menuitems'); ?>
