...
function bbp_user_profile_url()
{
}
function bbp_get_user_slug()
{
}
function bbp_displayed_user_field( $field = '', $filter = 'display' )
{
}
function bbp_subscriptions_permalink()
{
}
...
function bbp_user_replies_created_url()
{
}
...
function bbp_user_engagements_url()
{
}
...
function bbp_favorites_permalink()
{
}
...
function bbp_user_profile_edit_url()
{
}
